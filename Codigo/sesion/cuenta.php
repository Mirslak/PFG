...
<?php
    ...
    include "../includes/cabeceraSimp.php";
...
<div align="center">
  <div class="card" style="max-width: 800px;">
    <div class="card-header" >
        ...
        <img src="../../Imagenes/img-read/Distribucionestop.png"  width="100px" alt="" id="foto">
        </a>
    </div>
    <div class="card-body">
        <h3 class="border-2 mt-3 text-uppercase" align="center">Mi perfil</h3>  
        <form id="editarUsuario" enctype="multipart/form-data" method="post" class="needs-validationC">
            <div class="row">  
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="usuario" id="usuario" class="form-control" value="<?php echo $Usuario; ?>"required alt="complete"> 
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $Nombre; ?>"required alt="complete">
                        <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="password" id="password" class="form-control" alt="complete" value="<?php echo $Password?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="apellido1" id="apellido1" class="form-control" value="<?php echo $Apellido1; ?>"required alt="complete">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div align="left"><h5> DNI</h5></div>
                        <div class="input-group">
                            ...
                            <input type="text" name="dni" id="dni" class="form-control" value="<?php echo $Dni; ?>" alt="cc" required>
                            <div class="invalid-feedback">
                            DNI no válido.
                            </div>
                            <div class="valid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="apellido2" id="apellido2" class="form-control" value="<?php echo $Apellido2; ?>"required alt="complete">
                            <div class="invalid-feedback">
                            Por favor, escriba su apellido.
                            </div>
                            <div class="valid-feedback">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" value="<?php echo $Correo; ?>"required alt="complete">
                ...
                <!-- Termina Correo -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="telefono" id="telefono" class="form-control" value="<?php echo $telefono; ?>" required alt="complete">
                            <div class="invalid-feedback">
                ...
                <!-- Termina Direccion -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input  type="number" class="form-control" name="codigoP" id="codigoP" value="<?php echo $Cpostal ?>" required>
                            <div class="invalid-feedback">
            ...
            <div align="center">
                <div style="width: 50%">
                    <input name="actualizar" value="Actualizar Usuario" type="submit" class="btn btn-success form-control " style="border: black 2px solid" alt="complete" alt="complete">
                </div>
            </div>
        </form>
    </div>
...
if(isset($_POST['actualizar'])){
    ...
    $estado = $_POST['estado'];
		...
		$consulta = ModificarUsuario($conexion, $idUsuario, $usuario, $password, $nombre, $apellido1, $apellido2, $email,$estado, $telefono, $codigoP, $direccion, $dni);

...
<?php
 ...
 <div align="center">
   <div class="card" style="max-width: 800px;">
     ...
     <div class="card-body">
         <h3 class="border-2 mt-3 text-uppercase" align="center">Mis datos</h3>  
 ...
 if(isset($_POST['actualizar'])){
     ...
     //Recogemos los datos del formulario
      ...
      $rol = $_POST['rol_usuario'];
         ...
         $consulta = ModificarUsuario($conexion, $idUsuario, $usuario, $password, $nombre, $apellido1, $apellido2, $email,$estado, $telefono, $codigoP, $direccion, $dni, $rol);
         ...
         if($consulta){
             ...
             echo "<script>
                 Swal.fire({
                 type: 'error',
                 title: 'Error al editar sus datos. 1',
                 showConfirmButton: false,
                 });
                 </script>";
         }

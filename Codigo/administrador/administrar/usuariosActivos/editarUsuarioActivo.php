...
<div align="center">
  <div class="card" style="max-width: 800px;">
    ...
    <div class="card-body">
        <h3 class="border-2 mt-3 text-uppercase" align="center">Editar Usuario Activo</h3>  
        <form id="editarUsuario" enctype="multipart/form-data" method="post" class="needs-validationC">
            ...
            <div align="center">
                <div style="width: 50%">
                    <input name="actualizar" value="Actualizar Usuario" type="submit" class="btn btn-warning form-control " style="border: black 2px solid" alt="complete" alt="complete">
                </div>
            </div>
        </form>
    </div>
...
if(isset($_POST['actualizar'])){
    ...
    $rol_usuario = $_POST['rol_usuario'];
		...
		$consulta = ModificarUsuario($conexion, $idUsuario, $usuario, $password, $nombre, $apellido1, $apellido2, $email,$estado, $telefono,$codigoP, $direccion, $dni, $rol_usuario);
        ...
        if($consulta){
            ...
            echo'<meta http-equiv="Refresh" content="1;url=usuariosActivos.php">';
        } else {
            echo "<script>
                Swal.fire({
                type: 'error',

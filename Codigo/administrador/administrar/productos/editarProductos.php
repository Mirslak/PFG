...
<?php
    ...
    $row_edit = mysqli_fetch_assoc($get_producto);
    
    //Guardamos los datos del usuario
    $idProducto = $row_edit['id_producto'];
        
    $Nombre = $row_edit['nombre'];

    $Precio = $row_edit['precio'];
...
<div align="center">
  <div class="card" style="max-width: 800px;">
        ...
        <div class="card-body">
            <h3 class="border-2 mt-3 text-uppercase" align="center">Editar Productos</h3>  
            <form id="editarProducto" enctype="multipart/form-data" method="post" class="needs-validationC">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="invalid-feedback">
                                El nombre tiene una longitud mínima de 6 caracteres y máximo de 20 caracteres, no se permiten acentos, espacios ni caracteres especiales.
                            </div>
                    ...
                    <!-- Termina Precio -->  
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="marca" id="marca" class="form-control" value="<?php echo $Marca; ?>" required alt="complete">
                        ...
                        <!-- Descripción -->
                            ...
                            <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="descripcion" id="descripcion" class="form-control" value="<?php echo $Descripcion; ?>" required alt="complete">
                ...
                <div align="center">
                    <div style="width: 50%">
                        <input name="actualizar" value="Actualizar producto" type="submit" class="btn btn-warning form-control " style="border: black 2px solid" alt="complete">
                    </div>
                </div>
...
if(isset($_POST['actualizar'])){
	...
	$consulta = ModificarProducto($conexion, $idProducto, $Nombre, $Precio, $Marca, $Descripcion,$nombreImg);

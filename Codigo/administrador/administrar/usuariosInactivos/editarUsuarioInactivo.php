...
<div align="center">
  <div class="card" style="max-width: 800px;">
    ...
    <div class="card-body">
        <h3 class="border-2 mt-3 text-uppercase" align="center">Editar Usuario Inactivo</h3>  
        <form id="editarUsuario" enctype="multipart/form-data" method="post" class="needs-validationC">
            ...
            <div align="center">
                <div style="width: 50%">
                    <input name="actualizar" value="Actualizar Usuario" type="submit" class="btn btn-warning form-control " style="border: black 2px solid" alt="complete">
                </div>
            </div>
             </form>
        </div>
